...
public interface ExpenseService {
    ...
    Model createModelForExpensesTemplate(Model model, User user, String typeFilter, BigDecimal maxAmount, BigDecimal minAmount, LocalDate startDate, LocalDate endDate, String timePeriod);
}
